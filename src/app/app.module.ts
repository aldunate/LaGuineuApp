...
// Plugins
import { MaterialAngularModule, MY_FORMATS } from './util/plugins/materialAngular';
import { MatNativeDateModule, MAT_DATE_FORMATS, MAT_DATE_LOCALE, DateAdapter } from '@angular/material';
import 'hammerjs';
import { MomentDateAdapter } from '@angular/material-moment-adapter';
import { ImgUploadComponent } from './util/genericComponents/file-upload/img-upload.component';
